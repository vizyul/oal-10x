const stripeConfig = {
  ...
  subscriptionTiers: {
    free: {
      name: 'Free',
      priceId: null,
      features: ['1 free video', '8 Thumbnails/video', 'Basic AI summaries', 'Community support'],
      videoLimit: 1,
    ...
    enterprise: {
      ...
      yearly: {
        ...
        price: 2190,
        monthlyEquivalent: 182.50,
        originalMonthlyTotal: 2628,
        savings: 438,
        period: 'year'
      },
      features: ['50 videos/month', 'Unlimited Thumbnails', 'All PREMIUM Content Types', 'Blog Post', 'Podcast Script', 'Study Guide', 'Discussion Guide', 'Quiz', 'Quotes', 'Social Carousel', 'Group Chat Guide'],
      videoLimit: 50,
      analyticsAccess: true,
      apiAccess: true
    }
